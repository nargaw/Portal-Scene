...
//portal light colors
debugObject.portalColorStart = '#444628'
debugObject.portalColorEnd = '#dcc888'
...
const portalLightMaterial = new THREE.ShaderMaterial({
    uniforms: {
        uTime: { value: 0 },
        uColorStart: { value: new THREE.Color(0x444628) },
        uColorEnd: { value: new THREE.Color(0xdcc888) }
    }, 
